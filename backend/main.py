...
SEED_POLICIES = [
    ("p1",  "POL-2024-00101", "c1",  "Amina Wanjiku Mwangi",    "motor",   "2024-01-15", "2025-01-15", 28500,  "active"),
    ("p2",  "POL-2024-00102", "c1",  "Amina Wanjiku Mwangi",    "medical", "2024-03-01", "2025-03-01", 45000,  "active"),
    ("p3",  "POL-2024-00103", "c2",  "Brian Otieno Odhiambo",   "motor",   "2024-02-10", "2024-11-15", 32000,  "expired"),
    ("p4",  "POL-2024-00104", "c3",  "Catherine Njeri Kamau",   "motor",   "2024-04-01", "2025-04-01", 25000,  "active"),
    ("p5",  "POL-2024-00105", "c3",  "Catherine Njeri Kamau",   "medical", "2024-06-15", "2025-06-15", 60000,  "active"),
    ("p6",  "POL-2024-00106", "c3",  "Catherine Njeri Kamau",   "fire",    "2024-01-01", "2024-12-31", 18000,  "active"),
    ("p7",  "POL-2024-00107", "c4",  "David Kipchoge Rotich",   "motor",   "2024-05-20", "2025-05-20", 35000,  "active"),
    ("p8",  "POL-2024-00108", "c4",  "David Kipchoge Rotich",   "fire",    "2023-11-01", "2024-11-01", 22000,  "expired"),
    ("p9",  "POL-2024-00109", "c5",  "Eunice Akinyi Omondi",    "medical", "2024-07-01", "2025-07-01", 52000,  "pending"),
    ("p10", "POL-2024-00110", "c6",  "Francis Mwenda Mutua",    "motor",   "2024-03-15", "2025-03-15", 29000,  "active"),
    ("p11", "POL-2024-00111", "c6",  "Francis Mwenda Mutua",    "fire",    "2024-08-01", "2025-08-01", 15000,  "active"),
    ("p12", "POL-2024-00112", "c8",  "Hassan Abdi Mohamed",     "motor",   "2024-02-28", "2025-02-28", 41000,  "active"),
    ("p13", "POL-2024-00113", "c8",  "Hassan Abdi Mohamed",     "medical", "2024-09-01", "2025-09-01", 75000,  "active"),
    ("p14", "POL-2024-00114", "c9",  "Irene Wambui Gichuru",    "motor",   "2024-10-15", "2025-11-05", 27000,  "active"),
    ("p15", "POL-2024-00115", "c9",  "Irene Wambui Gichuru",    "fire",    "2024-04-01", "2025-04-01", 19500,  "active"),
    ("p16", "POL-2024-00116", "c13", "Martin Kariuki Mwangi",   "motor",   "2024-01-20", "2025-01-20", 33000,  "active"),
    ("p17", "POL-2024-00117", "c13", "Martin Kariuki Mwangi",   "medical", "2024-05-01", "2025-05-01", 48000,  "active"),
    ("p18", "POL-2024-00118", "c16", "Phyllis Cherotich Sang",  "motor",   "2024-07-10", "2025-07-10", 26500,  "active"),
    ("p19", "POL-2024-00119", "c19", "Samuel Waweru Mungai",    "motor",   "2024-11-10", "2025-11-10", 38000,  "active"),
    ("p20", "POL-2024-00120", "c21", "Usman Farah Abdi",        "fire",    "2024-06-01", "2024-11-20", 17000,  "active"),
]
